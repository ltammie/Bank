...
(
 "client_id"    bigint NOT NULL DEFAULT auto_increment,
...
(
 "account_id"     bigint NOT NULL DEFAULT auto_increment,
...
CREATE TABLE "cards"
(
 "card_id"         bigint NOT NULL DEFAULT auto_increment,
...
('John', '1-222-333-44-55', '1234 321123'),
('Maria', '5-444-333-22-11', '4321 123321');
